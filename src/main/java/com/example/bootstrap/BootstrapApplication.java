...
//          Sum {}
//소문자 작성 : 함수명()과 변수명
//카멜법 : 두단어를 사용할 때 두번째 단어의 첫글자를 대문자로(함수와 변수에 사용)
//        kokSum()
//더블카멜 : 세 단어를 사용할 때 두번째, 세번째 단어의 첫글자를 대문자로(함수와 변수)
//          summerKorSum()
//헝가리식 : 단어와 단어사이에 _ 연결, 모든단어 소문자
//          kok_sum ==> C언어
...
//          service와 기능 비슷함. service는 테이블과 관련된 작업, 그외는 util에
//                        Entity --------: Modelmapper
